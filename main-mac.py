...
def switch_to_yt_tab(e):
    ...
    e.control.page.settings_tab.visible = False
...
def switch_to_set_tab(e):
    e.control.page.title= "Settings"
    set_theme(e,"Blue")
    e.control.page.youtube_tab.visible = False
    e.control.page.spotify_tab.visible = False
    e.control.page.apple_music_tab.visible = False
    e.control.page.settings_tab.visible = True
...
def main(page: ft.Page):
    ...
    page.settings_tab = settings_tab
    page.overlay.extend([ get_directory_dialog])
    
    page.add(
        youtube_tab,spotify_tab,apple_music_tab,settings_tab
    )
    for i in range(0, 101):
            pb.value = i * 0.01
            time.sleep(0.1)
